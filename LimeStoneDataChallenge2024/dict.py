...
for p_id in range(1,202):
    ...
    for i in range(8):
        trust_list[7+i]=l[2*i + 1]/(l[2*i]+l[2*i+1])*100
    players_trust_list.append(trust_list)
    # print(p_id , trust_list)
# print(players_trust_list)
# for blai in range(201):
#     if(players_trust_list[blai][7] > 80 and players_trust_list[blai][8] > 80 and players_trust_list[blai][9]>85  and players_trust_list[blai][11]>80 and players_trust_list[blai][12]>80 and players_trust_list[blai][13]>80 and players_trust_list[blai][10] > 80 and players_trust_list[blai][14] < 15):
#         print(blai+1)
